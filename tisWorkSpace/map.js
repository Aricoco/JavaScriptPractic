...
(function(g){
    ...
    B.mapNavigation={
        ...
        buttons:{
            zoomIn:{onclick:function(){this.mapZoom(0.5)},text:"+",y:-32},
    ...
    t(r.prototype,"getSeriesExtremes",
        function(a){
            var b=this.isXAxis,
                ...
                e=[];
            l(this.series,
                function(a,b){if(a.useMapGeometry)e[b]=a.xData,a.xData=[]}
            );
            a.call(this);
